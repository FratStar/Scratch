...
typedef struct MESSAGE_T
{
  ...
  arUI32 fadeout[MAXMES];     /*this is when the test will fade out.*/
  arUI32 color[MAXMES]; 
  int last;
}Message;
...
void DrawTextCentered(char *text,SDL_Surface *surface,int sx,int sy,arUI32 color,int size)
{
...
void DrawText(char *text,SDL_Surface *surface,int sx,int sy,arUI32 color,int size)
{
  SDL_Surface *temp1 = NULL;
  SDL_Surface *fontpic = NULL;
  SDL_Color colortype,bgcolor;
