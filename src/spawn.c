...
{
  {
    {10,26,40,67},             /*bounding box for wall detection*/
    "player_start",                 /*the name of the entity*/
    "images/player/playershipsheet.png",      /*the sprite for the main part of the entity*/
    119,72,                    /*width and height of sprite dimensions*/
